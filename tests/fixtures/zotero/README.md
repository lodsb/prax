...
| `UW29C5GP` | `sid-guts-diy-controls.pdf` — one EAGLE schematic sheet of a published DIY synthesizer kit | no terms stated in the file; a one-page test of the studio module's schematic reading |
